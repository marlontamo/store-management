  ...
  <aside class="control-sidebar control-sidebar-dark">
    ...
    <div class="tab-content">
      ...
      <div class="tab-pane" id="control-sidebar-home-tab">
        <h3 class="control-sidebar-heading">Recent right Activity</h3>
...
<!-- jQuery UI 1.11.4 -->
<script src="<?php echo base_url('assets/Admin_lte/bower_components/jquery-ui/jquery-ui.min.js');?>"></script>
...
<!-- Morris.js charts -->
<script src="<?php echo base_url('assets/Admin_lte/bower_components/raphael/raphael.min.js');?>"></script>
<script src="<?php echo base_url('assets/Admin_lte/bower_components/morris.js/morris.min.js');?>"></script>
<!-- Sparkline -->
<script src="<?php echo base_url('assets/Admin_lte/bower_components/jquery-sparkline/dist/jquery.sparkline.min.js');?>
"></script>
<!-- jvectormap -->
...
<!-- jQuery Knob Chart -->
<script src="<?php echo base_url('assets/Admin_lte/bower_components/jquery-knob/dist/jquery.knob.min.js');?>"></script>
<!-- daterangepicker -->
...
<!-- FastClick -->
<script src="<?php echo base_url('assets/Admin_lte/bower_components/fastclick/lib/fastclick.js');?>
"></script>
<!-- AdminLTE App -->
