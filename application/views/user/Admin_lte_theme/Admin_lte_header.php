...
<head>
  ...
  <!-- Morris chart -->
  <link rel="stylesheet" href="<?php echo base_url('assets/Admin_lte/bower_components/morris.js/morris.css');?>">
  <!-- jvectormap -->
  <link rel="stylesheet" href="<?php echo base_url('assets/Admin_lte/bower_components/jvectormap/jquery-jvectormap.css');?>">
  <!-- Date Picker -->
  ...
  <link rel="stylesheet" href="<?php echo base_url('assets/Admin_lte/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.min.css');?>">
      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
              ...
              <li>
                ...
                <ul class="menu">
                  <li><!-- start message -->
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo base_url('assets/Admin_lte/dist/img/user1-128x128.jpg');?>" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Support Team
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo base_url('assets/Admin_lte/dist/img/user4-128x128.jpg');?>" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Developers
                  ...
                  <li>
                    <a href="#">
                      <div class="pull-left">
                        <img src="<?php echo base_url('assets/Admin_lte/dist/img/user3-128x128.jpg');?>" class="img-circle" alt="User Image">
                      </div>
                      <h4>
                        Sales Department
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="<?php echo base_url('assets/Admin_lte/dist/img/user1-128x128.jpg');?>" class="user-image" alt="User Image">
